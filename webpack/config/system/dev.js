...
module.exports  =   {
                        ...
                        entry: {
                            ...
                            // frontend base
                            desktop:        ["./files/js/actilog/desktop/root.js"],        // babel polyfill will be automatically required at the start - enabling native Promise, Object.assign etc
                            mobile:       	["./files/js/actilog/mobile/root.js"],
                        ...
                        devServer:  {
							...
							// port: 4335, // whole sheo site
                            port: 4337, // ... only the soul app (sheo site front)
